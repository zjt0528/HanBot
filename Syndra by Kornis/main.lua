...
if not avada_lib then
	...
	print("You need to have Avada Lib in your community_libs folder to run 'Syndra by Kornis'!")
...
elseif avada_lib.version < 1 then
	console.set_color(12)
	print("Your need to have Avada Lib updated to run 'Syndra by Kornis'!")
	print("You can find it here:")
	console.set_color(11)
	print("https://gitlab.soontm.net/get_clear_zip.php?fn=avada_lib")
	console.set_color(15)
...
menu.combo:boolean("slowpred", "Use Slow Predictions for QE", false)
