...
if not avada_lib then
	...
	print("You need to have Avada Lib in your community_libs folder to run 'Master Yi by Kornis'!")
...
elseif avada_lib.version < 1 then
	console.set_color(12)
	print("Your need to have Avada Lib updated to run 'Master Yi  by Kornis'!")
	print("You can find it here:")
	console.set_color(11)
	print("https://git.soontm.net/avada/avada_lib/archive/master.zip")
	console.set_color(15)
